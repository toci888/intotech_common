...
{
    public class IDtoLogicHandlerPanel : ILogicGenerationPanel
    {
        public IDtoLogicHandlerPanel()
        {
            BannerLabel.Text = "ILogic Handler Generator";
        }
        ...
        protected override void HandleClick(object? sender, EventArgs eventArgs)
        {
            if (OutputDirectory.Text != null || Usings.Text != null || NameSpace.Text != null || modelPath != null)
            {
                ...
                bool reloadMethod = Realizator.ILogicHandlerRender(modelPath, outputDirectory, usings, nameSpace, dontDelFiles);
