...
public class DbHandleMultiThreading<TModel> : IDbHandle<TModel>, IDisposable where TModel : ModelBase
{
    ...
    public DbHandleMultiThreading(Func<DbContext> databaseHandle)
    {
        FDatabaseHandle = databaseHandle;
    }

    public DbHandleMultiThreading(Func<DbContext> databaseHandle, string connectionString)
    {
        FDatabaseHandle = databaseHandle;
